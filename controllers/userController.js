...
exports.apiLogin = function (req, res) {
  ...
  user
    .login()
    .then(function (result) {
      res.json(jwt.sign({ _id: user.data0._id }, process.env.JWTSECRET, { expiresIn: tokenLasts }))
    })
    .catch(function (e) {
      res.json("username not found in this universe")
    })
}
...
exports.profilePostsScreen = function (req, res) {
  ...
  Post.findByCreatorId(req.profileUser._id)
    .then(function (posts) {
      res.render("profile", {
